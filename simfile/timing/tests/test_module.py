...
class TestBeatValues(unittest.TestCase):
    def test_from_str(self):
        ...
        self.assertEqual(
            BeatValue(beat=Beat(0, 1), value=Decimal("128.000")), events[0]
        )
        self.assertEqual(
            BeatValue(beat=Beat(132, 1), value=Decimal("64.000")), events[1]
        )
        self.assertEqual(
            BeatValue(beat=Beat(147 * 2 + 1, 2), value=Decimal("128.000")), events[2]
        )
